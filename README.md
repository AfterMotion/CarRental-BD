...
> **Module 34 Assignment** - Car Rental Web Application built with Laravel 13

## 📽️ Project Presentation Video

> _Upload your video to Google Drive and paste the link here._
...
- 🗓️ My Bookings - view & cancel upcoming rentals
- 🔐 Register / Login / Logout

### Technical

- ✉️ Email notifications on booking (to customer + admin)
- 🔒 Role-based access control (admin / customer)
- 🖼️ Car image upload & storage
